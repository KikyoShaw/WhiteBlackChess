...
void Interface::setBackgroundColor(int r, int g, int b)
{
    m_colorR = r;
    m_colorG = g;
    m_colorB = b;
...
// 设置标题栏图标;
void Interface::setTitleIcon(QString filePath, QSize IconSize)
{
...
// 设置标题内容;
void Interface::setTitleContent(QString titleContent, int titleFontSize)
{
    // 设置标题字体大小;
...
// 设置标题栏长度;
void Interface::setTitleWidth(int width)
{
...
void Interface::setButtonType(ButtonType buttonType)
{
...
// 一般情况下标题栏中的标题内容是不滚动的
void Interface::setTitleRoll()
{
    connect(&m_titleRollTimer, SIGNAL(timeout()), this, SLOT(onRollTitle()));
    m_titleRollTimer.start(500);
}

// 设置窗口边框宽度;
void Interface::setWindowBorderWidth(int borderWidth)
{
    m_windowBorderWidth = borderWidth;
}

// 保存窗口最大化前窗口的位置以及大小;
void Interface::saveRestoreInfo(const QPoint point, const QSize size)
{
    m_restorePos = point;
    m_restoreSize = size;
}
...
// 获取窗口最大化前窗口的位置以及大小;
void Interface::getRestoreInfo(QPoint& point, QSize& size)
{
    point = m_restorePos;
    size = m_restoreSize;
}
...
void Interface::loadStyleSheet(const QString &sheetName)
{
...
// 以下为按钮操作响应的槽;
void Interface::onButtonMinClicked()
{
    emit signalButtonMinClicked();
}

void Interface::onButtonRestoreClicked()
{
    m_pButtonRestore->setVisible(false);
...
void Interface::onButtonMaxClicked()
{
    m_pButtonMax->setVisible(false);
...
void Interface::onButtonCloseClicked()
{
    emit signalButtonCloseClicked();
}

// 该方法主要是让标题栏中的标题显示为滚动的效果;
void Interface::onRollTitle()
{
    static int nPos = 0;
